 ...
 * CC format keys are "name@marketplace"; manifests reference plugins by the
 * bare name. Single source of truth for the key→name transform. lastIndexOf
 * keeps scoped names intact (@scope/name@marketplace → @scope/name); bare
 * names and keys with no marketplace suffix pass through unchanged.
 */
