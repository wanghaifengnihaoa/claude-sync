...
function charDisplayWidth(code) {
  ...
  // skin-tone modifiers occupy no terminal columns. Width stays approximate
  // for multi-codepoint emoji graphemes (a ZWJ family emoji renders as one
  // glyph but is measured per codepoint) — the common CJK/fullwidth cases
  // this guards are all single-codepoint and exact.
  if (
  ...
  return (
    ...
    (code >= 0x1f000 && code <= 0x1f2ff) || // Mahjong / Dominoes / Playing cards
